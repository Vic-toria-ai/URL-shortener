const Stats = () => {
  return (
    <div className="bg-gray-100 pt-20">
      <div className="max-w-xl mx-auto text-center mt-10 p-8">
      ...
      <section className="relative max-w-6xl mx-auto mt-20 px-5 md:flex md:justify-between md:gap-4">
        ...
        {/* icon background */}
          ...
          {/* card title */}
          <h4 className="text-lg font-bold text-gray-800 mt-8 text-center md:text-left">Brand Recognition</h4>
          {/* card description */}
        ...
        {/* icon background */}
          ...
          {/* card title */}
          <h4 className="text-lg font-bold text-gray-800 mt-8 text-center md:text-left">Detailed Records</h4>
          {/* card description */}
          <p className="mt-4 text-gray-500 text-center md:text-left font-semibold ">
            Gain insights into who is clicking your links. Knowing when and where people engage with your contents helps inform better decisions.
          </p>
        </div>
        ...
        {/* icon background */}
          ...
          {/* card title */}
          <h4 className="text-lg font-bold text-gray-800 mt-8 text-center md:text-left">Fully Customizable</h4>
          {/* card description */}
          <p className="mt-4 text-gray-500 text-center md:text-left font-semibold ">
      ...
      {/* CTA section */}
        ...
        <h3 className="text-center text-2xl font-bold text-white">Boot your links today</h3>
        <button className="bg-cyan-400 text-white py-2 px-6 rounded-full hover:bg-cyan-500 font-bold transition duration-300 md:w-auto mt-6">Get Started</button>
        </div>
    </div>
